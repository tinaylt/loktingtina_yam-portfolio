<?php
    ...
    $lname = trim($lname);
    $email = trim($email);
    $msg = trim($message); // Ensure $msg is used consistently for the message field
    ...
    if(empty($msg)) { // Check $msg (which is trimmed $message)
    ...
    if($errorcount > 0) {
        ...
        $stmt->bindParam(':msg', $msg); // Use $msg here
        ...
        $email_message .= "Message:\n" . $msg; // Use $msg for the email message content
